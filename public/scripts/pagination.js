$(document).ready(function() {
  ...
  , spacing = parseFloat($dots.css("width")) + (parseFloat($dots.css("marginLeft")) * 2), halfSpacing = spacing / 2, startPos

  , itemsSpacing = 450, lastItem = 0, lastItemR = 0, lastTime = Date.now();
